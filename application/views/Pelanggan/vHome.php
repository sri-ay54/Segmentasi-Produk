	...
	<div class="container">
		<div class="row justify-content-between">
			<div class="col-lg-6">
				...
				<p>Kami menyediakan berbagai kebutuhan keluarga yang hadir dengan kualitas sangat baik. 
					Berbagai keperluan keluarga bisa didapatkan, peralatan rumah tangga, sembako, pakaian, alat sekolah dan banyak lainnya</p>
				...
				<div class="row my-5">
					<div class="col-6 col-md-6">
						<div class="feature">
							...
							<h3>Fast</h3>
							<p>Dengan pengiriman yang cepat menjamin ketersediaan kepeluan anda.</p>
						</div>
					</div>
					...
					<div class="col-6 col-md-6">
						<div class="feature">
							...
							<p>Dengan harga terjangkau memudahkan dalam menyediakan keperluan rumah dengan kualitas terbaik.</p>
						</div>
					</div>
					...
					<div class="col-6 col-md-6">
						<div class="feature">
							...
							<h3>Easy to Shop</h3>
							<p>Solusi bagi anda yang tidak banyak waktu dan menghemat waktu untuk sampai ke toko.</p>
						</div>
					</div>
					...
					<div class="col-6 col-md-6">
						<div class="feature">
							...
							<h3>Discount</h3>
							<p>Update discount barang yang menghemat yang pasti dengan kualitas yang tinggi.</p>
						</div>
					</div>
			...
			<div class="col-lg-5">
				<div class="img-wrap">
					<img src="<?= base_url('asset/pelanggan/') ?>images/d2.jpg" alt="Image" class="img-fluid">
				</div>
			</div>
				...
				<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0 mt-5">
					<form action="<?= base_url('pelanggan/chome/cart') ?>" method="POST">
						...
						<a class="product-item" href="#">
							<img style="widht: 250px; height: 200px" src="<?= base_url('asset/foto-produk/' . $value->gambar) ?>" class="img-fluid product-thumbnail">
