		...
		<div class="container relative">
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="subscription-form">
						<h3 class="d-flex align-items-center"><span class="me-1"><img src="<?= base_url('asset/pelanggan/') ?>images/envelope-outline.svg" alt="Image" class="img-fluid"></span>
						<span>Toko Mutuara 99</span></h3>
			...
			<div class="row g-5 mb-5">
				<div class="col-lg-4">
					...
					<p class="mb-4">Kami menjual berbagai macam peralatan rumah tangga dan 
						macam-macam sembako rumah tangga dan kebutuhan sehari-hari.
						Kami berada di Jalan Raya Susukan desa cimaranten Kecamatan Cipicung Kabupaten Kuningan Jawa Barat</p>
