...
<body class="img js-fullheight" style="background-image: url(<?= base_url('asset/login/') ?>images/av.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Halaman Login Kepala Toko dan Pemilik Toko
					Toko Mutiara 99</h2>
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<h3 class="mb-4 text-center">Silahkan Masukan Username & Password</h3>
